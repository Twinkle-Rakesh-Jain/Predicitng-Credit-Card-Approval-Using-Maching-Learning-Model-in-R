...
setwd('/Users/twinklejain/Desktop/Data Analysis Project/Credit Card Default Prediction in R')
...
#Checking the column names in the merged dataset:
colnames(creditcard)
...
#To indicate that the column is a categorical variable rather than a continuous one
